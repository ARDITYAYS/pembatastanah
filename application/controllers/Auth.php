...
class Auth extends CI_Controller
{
    ...
    public function buat()
    {
        ...
        $this->form_validation->set_rules('email', 'Email', 'required|trim|valid_email|is_unique[user.email]', [
            'is_unique' => 'This email ha already registered'
        ]);
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'AJABOSEN BUAT AKUN';
            $this->load->view('templates/auth_header', $data);
            $this->load->view('auth/buat');
            $this->load->view('templates/auth_footer');
        } else {
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'vinejiyaapril@gmail.com',
            'smtp_pass' => 'wendy210294',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n"
        ...
        $this->email->from('vinejiyaapril@gmail.com', 'Badan Keuangan Daerah');
    ...
    public function verify()
    {
        ...
        if ($user) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
            Account activation failed! Wrong emali 
          </div>');
            redirect('auth');
        }
    }
    ...
    public function forgotpassword()
    {
        ...
        if (
            ...
            if ($user) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
                 Email is not registerd or activated
                         </div>');
                redirect('auth/forgotpassword');
            }
        }
